...
import { FaCog, FaImage, FaPencilAlt, FaTrash } from "react-icons/fa";
            ...
            >
              ...
              <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                <div className="flex items-center">
                  <div className="inline-block w-2 h-2 mr-2 bg-green-500 rounded-full"></div>
                  {product.stock ?? 1}
                </div>
              </td>

              <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                {format(product.createdAt, "dd, MMM ,yyy")}
              </td>
